...
public class OpenApiUtil {
  ...
  public OpenApiUtil(String yamlFilePath) {
    System.setProperty("maxYamlAliasesForCollections", Integer.MAX_VALUE + "");
    System.setProperty("maxYamlDepth", Integer.MAX_VALUE + "");
  ...
  public Schema getResponseSchema(
      String apiPath, PathItem.HttpMethod httpMethod, String statusCode) {
    PathItem pathItem = openAPI.getPaths().get(apiPath);
    if (pathItem == null) {
      return null;
    }
    ...
    if (operation == null
        ...
        || operation.getResponses().get(statusCode) == null) {
      return null;
    }
